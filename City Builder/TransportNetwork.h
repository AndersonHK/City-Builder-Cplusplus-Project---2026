...
private:
    ...
    bool hasPedestrianNeighborOnEitherEnd(TransportLayerId layer, int tileX, int tileY, const RoadLanePlacement& pedestrianLane, bool includeInactiveLanes) const;
    bool pedestrianLaneMeetsCrossingPedestrianLane(TransportLayerId layer, int tileX, int tileY, const RoadLanePlacement& pedestrianLane, bool includeInactiveLanes) const;
    bool pedestrianLaneHasEndpointConnection(TransportLayerId layer, int tileX, int tileY, const RoadLanePlacement& pedestrianLane, bool includeInactiveLanes) const;
    ...
    std::uint8_t pedestrianLaneCrosswalkMask(TransportLayerId layer, int tileX, int tileY, const RoadLanePlacement& pedestrianLane, const TransportTile& tile, std::uint8_t pedestrianGraphicMask) const;
